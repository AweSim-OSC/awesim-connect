...
namespace AweSimConnect.Controllers
{
    class SFTPControllerWinSCP
    {
        ...
        public void StartSFTPProcess(string password)
        {
            ...
            info.Arguments = String.Format(WINSCP_ARGS, this.Connection.UserName, Uri.EscapeDataString(password), OSCClusterController.SFTP_CLUSTER.Domain, SFTP_PORT, this.RemotePath);
